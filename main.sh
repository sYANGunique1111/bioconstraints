...
CHECKPOINT_DIR="hot_mixste_chunked_layer3_token81_feature_interp_attn_identifier_embed_joint_acc10_all"
...
TRAIN_ARGS=(
    ...
    "--attn_drop_rate" "0.0"
    "--drop_path_rate" "0.0"
    "--weight_temporal_bone" "0.0"
    "--weight_temporal_symmetry" "0.0"
    "--temporal_symmetry_tau" "0.0005"
    "--weight_joint_acc" "0.0"
    "--joint_acc_topk" "25"
    "--joint_acc_loss_type" "smooth_l1"
