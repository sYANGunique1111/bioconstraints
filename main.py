...
def runner(rank, args, train_data, test_data):
    ...
    if args.model == 'mixste':
        ...
        hot_args.decoder_mode = (
            'cross_attention' if getattr(args, 'decoder_mode', 'simple') == 'simple'
            else args.decoder_mode
        )
        hot_args.decoder_cross_pe = args.decoder_cross_pe
        hot_args.decoder_cross_attn_local_radius = args.decoder_cross_attn_local_radius
