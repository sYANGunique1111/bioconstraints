...
def parse_args():
    ...
    parser.add_argument('--model', default='mixste', type=str,
                        help='Model architecture: mixste, hybrid3, hybrid3_2, hybrid_mixste, hybrid_mixste_v2, hybrid_joint_conv, hybrid_jointwise_mixste, two_stage_grouped, two_stage_patched, hot_mixste, hot_mixste_chunked, hot_mixste_chunked_multistep, hot_mixste_multi, h2ot_mixste, h2ot_mixste_interp')
    ...
    parser.add_argument('--decoder_mode', default='simple', type=str,
                        help='Decoder mode for HybridJointWiseMixSTE: simple, one_step_interp, one_step_upsample, two_step_upsample, two_step_mix, cross_attn_recovery')
    ...
    parser.add_argument('--chunking_scheme', default='even', type=str,
                        help='Chunk layout for hot_mixste_chunked and hot_mixste_chunked_multistep: even, corner_aligned')
